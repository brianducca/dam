...
const iosTransitionAnimation = () => Promise.resolve().then(function () { return require('./ios.transition-4e5144c5.js'); });
const mdTransitionAnimation = () => Promise.resolve().then(function () { return require('./md.transition-a603a9fe.js'); });
